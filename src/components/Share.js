...
import maker from "../Functions/maker";
import "../css/share.css";
import location_search from "../Functions/location_search";
...
function Share() {
  ...
  useEffect(() => {
    ...
    kakao.maps.event.addListener(map, "click", function (mouseEvent) {
      ...
      maker(map, clickPosition, distance);
    });
    ...
    kakao.maps.event.addListener(map, "mousemove", function (mouseEvent) {
      ...
      if (drawingFlag) {
        ...
        var distance = Math.round(clickLine.getLength() + moveLine.getLength()), // 선의 총 거리를 계산합니다
          content =
            '<div class="dotOverlay distanceInfo">예상 거리 <span class="number">' +
            distance +
    ...
    function displayCircleDot(position, distance) {
      ...
      var distanceOverlay = new kakao.maps.CustomOverlay({
        content:
          '<div class="dot"><span class="number">' + text + distance + k_m,
        position: position,
        yAnchor: 1,
        zIndex: 2,
      });
  ...
  return (
    <>
      <div className="main">
        ...
        <div draggable="false" id="map"></div>
      </div>
      <div
        id="share_desc"
        style={{
